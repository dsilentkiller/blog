...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin/assets/css/johndoe.css') }}">
</head>
...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <!-- core  -->
    <script src="{{ asset('admin/assets/vendors/jquery/jquery-3.4.1.js') }}"></script>
    <script src="{{ asset('admin/assets/vendors/bootstrap/bootstrap.bundle.js') }}"></script>

    <!-- bootstrap 3 affix -->
    <script src="{{ asset('admin/assets/vendors/bootstrap/bootstrap.affix.js') }}"></script>

    <!-- Isotope  -->
    <script src="{{ asset('admin/assets/vendors/isotope/isotope.pkgd.js') }}"></script>
    ...
    <!-- JohnDoe js -->
    <script src="{{ asset('admin/assets/js/johndoe.js') }}"></script>
