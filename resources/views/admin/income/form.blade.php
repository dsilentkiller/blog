    ...
    <section class="content">
        <div class="container-fluid">
            <div class="form-group row btn-warning">
                <div class="col-md-3 col-sm-3 float-right"><a href="{{ route('income.index') }}">
                        <h6>View Income List</h6>
                    </a></div>
            ...
            @if (isset($income))
                <form action="{{ route('income.update', $income) }}" method="post" enctype="multipart/form-data">
                    {{ method_field('PATCH') }}
                @else
                    ...
                    <div class="container '">
                        <div class="card card-info">
                            ...
                            <div class="card-header">
                                <div class="card-title">Income @if (isset($income)) Update
                                    @else
                            ...
                            <div class="card-body">
                                <div class="form-group float-right">
                                    ...
                                    <input type="checkbox" name="status" value="1" data-bootstrap-switch
                                        @if (isset($income)) @if ($income->status) checked @endif
                                    @else checked @endif>
                                </div>
                                <div class="form-group "> <label for="date"> Date : <span
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="client_name" class="form-control"
                                            ...
                                            value="{{ old('client_name', @$income->client_name) }}">
                                        @error('client_name')
                                            <span class="alert alert-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="purpose" class="form-control" placeholder="Enter Name"
                                            value="{{ old('purpose', @$income->purpose) }}">
                                        @error('purpose')
                                            <span class="alert alert-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="person_address" class="form-control"
                                            ...
                                            value="{{ old('person_address', @$income->person_address) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="remark" class="form-control" placeholder="Enter Amount"
                                            value="{{ old('remark', @$income->remark) }}">
                                        @error('remark')
                                            <span class="alert alert-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="created_by" class="form-control"
                                            placeholder="Enter name" value="{{ old('created_by', @$income->created_by) }}">
                                        @error('created_by')
                                            <span class="alert alert-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    {{-- <div class="form-group">
										...
										<textarea class="form-control" style="height: 100px;" name="speech">{{old('speech', @$income->speech)}}</textarea>
										@error('speech')
										<span class="alert alert-danger">{{$message}}</span>
										@enderror
									</div> --}}
